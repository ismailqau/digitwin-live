/**
 * Health Service for WebSocket Server
 * Provides health check and readiness check functionality
 */
...
const SERVICE_NAME = 'websocket-server';
...
/**
 * Add external service health check (e.g., ASR, LLM, TTS services)
 */
export function addServiceCheck(
  name: string,
